        ...
        mGoogleApiClient = new GoogleApiClient.Builder(context)
                ...
                .addConnectionCallbacks(new GoogleApiClient.ConnectionCallbacks() {
                    ...
                    public void onConnected(Bundle bundle) {
                        Log.d(LOG_TAG, "Google Wear connected");
                    }
                ...
                .addOnConnectionFailedListener(new GoogleApiClient.OnConnectionFailedListener() {
                    ...
                    public void onConnectionFailed(ConnectionResult connectionResult) {
                        Log.d(LOG_TAG, "Google Wear onConnectionFailed " + connectionResult.getErrorMessage());
                    }
                })
                .build();
        ...
        try {
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                if (i == 0) {
                    ...
                    ;
                    putDataMapRequest.getDataMap().putString("weather_temp_high",
                            String.format("%d",Math.round(high)));
                    putDataMapRequest.getDataMap().putString("weather_temp_low",
                            String.format("%d",Math.round(low)));

                    int iconResourceForWeatherCondition = Utility.
                            getIconResourceForWeatherCondition(weatherId);
                    Bitmap bitmap = BitmapFactory.decodeResource(getContext().getResources(),
                            iconResourceForWeatherCondition);
